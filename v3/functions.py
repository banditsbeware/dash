...
class FunctionsV3():
    def animate(self):
        states = self.load_states() # load the states.csv file into this dict variable | format: {state: abbreviation}

        features = self.load_features() # loads the feature in to this dict variable | format: {feature id: feature name}
...
# TODO: implement new graphing method here
    ...
    def load_states_data(self, stateList):
        stateData=""
